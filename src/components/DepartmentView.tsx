...
const DepartmentView: React.FC<DepartmentViewProps> = ({
  ...
  // Enhanced placeholder image URLs to include new departments
  const getPlaceholderImage = (dept: string) => {
    const images: { [key: string]: string } = {
      ...
      Holter: "https://via.placeholder.com/150/84cc16/ffffff?text=Holter+Monitor",
      
      // New departments
      BIOPSY: "https://via.placeholder.com/150/dc2626/ffffff?text=Biopsy",
      DIALYSIS: "https://via.placeholder.com/150/0ea5e9/ffffff?text=Dialysis",
      MAMMOGRAPHY: "https://via.placeholder.com/150/ec4899/ffffff?text=Mammogram",
      "DENTAL-X-RAY": "https://via.placeholder.com/150/16a34a/ffffff?text=Dental+XRay",
      EEG: "https://via.placeholder.com/150/eab308/ffffff?text=EEG+Wave",
      DOPPLER: "https://via.placeholder.com/150/7c3aed/ffffff?text=Doppler",
    };
    
    // Handle case variations and fallback
    const normalizedDept = dept.toUpperCase();
    return (
      images[normalizedDept] ||
      images[dept] ||
      "https://via.placeholder.com/150/6b7280/ffffff?text=Medical+Image"
    );
  };

  // Get department display name for better formatting
  const getDepartmentDisplayName = (dept: string) => {
    ...
    return displayNames[dept.toUpperCase()] || dept;
  };
          ...
          <div className="content-section">
            <div className="section-header">
              <h3 className="section-title">
                ...
                {getDepartmentDisplayName(departmentName)} Reports Listing
              </h3>
            </div>
            ...
            {departmentReports.length === 0 ? (
              <div className="empty-state">
                ...
                <h3 className="empty-title">
                  No {getDepartmentDisplayName(departmentName)} reports found
                </h3>
                <p className="empty-description">
                  No reports have been uploaded for {getDepartmentDisplayName(departmentName)} department
                  yet
                </p>
              </div>
            ) : (
                      ...
                      <>
                        ...
                        <div className="report-field">
                          ...
                          <span className="report-value department-badge">
                            {getDepartmentDisplayName(report.department)}
                          </span>
                        </div>
                        <div className="report-field">
                          <span className="report-label">Report Type</span>
          ...
          <div className="content-section">
            <div className="section-header">
              <h3 className="section-title">
                ...
                {getDepartmentDisplayName(departmentName)} Firm Listing
              </h3>
            </div>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <img
                          ...
                          alt={`${getDepartmentDisplayName(departmentName)} Sample`}
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h3 className="modal-title">
                  {getDepartmentDisplayName(departmentName)} Report Details
                </h3>
                <button
                ...
                <div className="patient-info-section">
                  ...
                  <div className="info-grid">
                    ...
                    <div className="info-item">
                      ...
                      <span className="info-value">
                        {getDepartmentDisplayName(selectedReport.department)}
                      </span>
                    </div>
                    <div className="info-item">
